...
namespace CommonLibrary.Controls
{
    public partial class DateTimePicker
    {
        ...
        {
            TextBoxUpDownAdorner upDownButtons;
            InitializeComponent();
            ...
            Loaded += (s, e) =>
            {
                ...
                if (adLayer != null)
                {
                    adLayer.Add(upDownButtons = new TextBoxUpDownAdorner(DateDisplay));
                    upDownButtons.Click += (textBox, direction) => { OnUpDown(direction); };
                }
            };
        ...
        public static DependencyProperty MaximumDateProperty = DependencyProperty.Register("MaximumDate", typeof(DateTime), typeof(DateTimePicker), new FrameworkPropertyMetadata(Convert.ToDateTime("3000-01-01 00:00"), null, CoerceMaxDate));

        public static DependencyProperty MinimumDateProperty = DependencyProperty.Register("MinimumDate", typeof(DateTime), typeof(DateTimePicker), new FrameworkPropertyMetadata(Convert.ToDateTime("1900-01-01 00:00"), null, CoerceMinDate));
